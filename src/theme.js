// theme.js
// Extended color themes with more style keys for consistency
export const colorTheme = {
  "bg-white": {
    ...
    circleBorder: "border-gray-400 hover:border-gray-500",
    icon: "text-gray-700",
    inner_circle: "bg-red-900 border-white",
  },
  "bg-black": {
    ...
    button: "bg-white border text-gray-900 hover:bg-gray-900 hover:text-white hover:border-white",
    buttonOutline: "border border-white text-white hover:bg-white hover:text-gray-900",
    link: "text-teal-300 hover:text-teal-400",
    cardBg: "bg-gray-900 shadow-lg",
    border: "border-gray-300 border-2",
    input:
      "bg-gray-800 border border-gray-700 text-white focus:ring-2 focus:ring-gray-500",
    cursor: "bg-white",
    ...
    title: "text-white",
    background: "bg-black",
    circleBg: "bg-gray-800",
    circleBorder: "border-gray-500 hover:border-gray-400",
    icon: "text-white",
